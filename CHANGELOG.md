...
- TOC validation now strips trailing descriptions after 3+ consecutive spaces (e.g., `runner.rs       command dispatch`)
- TOC detection recognizes indentation-based trees with space-separated descriptions

## [0.4.2]

### Added

- Centralized `env.rs` module for runtime environment variables via build script

### Fixed

- Only detect `#[cfg(test)] mod` blocks as test modules (not individual `#[cfg(test)]` items)

### Changed

- Default `max_lines` for source files increased from 750 to 800
...
[Unreleased]: https://github.com/alfredjeanlab/quench/compare/v0.4.3...HEAD
[0.4.3]: https://github.com/alfredjeanlab/quench/compare/v0.4.2...v0.4.3
[0.4.2]: https://github.com/alfredjeanlab/quench/compare/v0.4.1...v0.4.2
